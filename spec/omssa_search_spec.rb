...
describe "The omssa_search command", :broken => false do
	...
	describe ["omssa_search.rb"] do
		...
		it_behaves_like "a protk tool with default file output", :dependencies_installed => omssa_installed
		it_behaves_like "a protk tool that supports explicit output", :dependencies_installed => omssa_installed do
